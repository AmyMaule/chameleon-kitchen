  ...
  return (
    <div className="conversion-options-container">
      <label className="conversion-option-label">
        Convert eggs
        <input className="conversion-option-checkbox" id="eggs" onChange={handleSelectedOptions} type="checkbox" />
      </label>
      <label className="conversion-option-label">
        {window.innerWidth > 380 ? "Convert teaspoons, tablespoons, etc." : "Convert tea/tablespoons, etc."}
        <input className="conversion-option-checkbox" id="tsp" onChange={handleSelectedOptions} type="checkbox" />
      </label>
    </div>
  );
};
